...
/**
 * This is Robot Utility Class
 */
public class RobotUtils extends java.lang.Thread {
     ...
     * @param tel
     */
    RobotUtils(HardwareMap map, Telemetry tel) {
        hardwareMap = map;
        telemetry = tel;
        initDevices();
    }
    ...
    /**
     * Generic Method to print telemetry update
     *
     * @param firstVariable
    ...
    public void unlatchUsingEncoderPosition(double power, int direction, double rotattion) {
        ...
        while (latch.isBusy()) {
            ...
            printTelemetryUpdate("Down", "Moving");
        }
    ...
    public void moveForwardToPosition(double power, int distance) {
        ...
        while (motor_0.isBusy()) {
            ...
            //Waiting for Robot to travel the distance
            printTelemetryUpdate("Backward", "Moving");
        }
    ...
    public void moveB(long distance) {
        printTelemetryUpdate("Direction", "Forward");
    ...
    public void moveF(long distance) {
        ...
        motor_2.setPower(0);
        motor_3.setPower(0);
        printTelemetryUpdate("Direction", "Backward");
        if (isTeleOp == false) pause(250);
    }
    ...
    public void moveR(long distance) {
        ...
        motor_2.setPower(0);
        motor_3.setPower(0);
        printTelemetryUpdate("Direction", "Left");
        if (isTeleOp == false) pause(250);
    }
    ...
    public void moveL(long distance) {
        ...
        motor_2.setPower(0);
        motor_3.setPower(0);
        printTelemetryUpdate("Direction", "Right");
        if (isTeleOp == false) pause(250);
    }
    ...
    private void initDeviceCore() throws Exception {
        ...
        printTelemetryUpdate("Please wait", "In function init devices");
        ...
        printTelemetryUpdate("Status", "Initialized");
