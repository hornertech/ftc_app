...
@Autonomous
public class AD extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robotUtils.moveRightToPosition(1, 4); //come out of latch
        robotUtils.moveBackwardForTime(0.25, 250, false); //align to back wall
        robotUtils.moveForwardToPosition(0.5, 17);  //Move forward to detect
        ...
        if (detect_result == GOLD_MINERAL_FOUND) {
            ...
            robotUtils.moveRightToPosition(0.5, 16);
            detect_result = detectOnceNew(robotUtils);
            if (detect_result == GOLD_MINERAL_FOUND) {
                ...
                robotUtils.moveBackwardToPosition(0.5, 14);
                //Come back to center
                robotUtils.moveLeftToPosition(0.5, 16);
            } else if (detect_result == NO_MINERAL_FOUND) {
                ...
                //Move left 32 in.
                robotUtils.moveLeftToPosition(0.5, 32);
                //Knock off mineral
                robotUtils.moveForwardToPosition(0.5, 14);
                robotUtils.pause();
                robotUtils.moveBackwardToPosition(0.5, 14);
        ...
        robotUtils.moveLeftToPosition(0.8, 43);
        robotUtils.turn(0.6, 900);
        robotUtils.wall_align(0.25, 1500);
        // robotUtils.pause();
        robotUtils.moveLeftToPosition(0.5, 3);
        robotUtils.moveForwardToPosition(0.75, 62);
        sleep(1000);
        ...
        //Begin Step 4
        robotUtils.moveBackwardToPosition(1, 72);
        time_taken = System.currentTimeMillis() - start_time;
        Log.i(TAG, "STEP 4: Completed after : " + time_taken + "Milli Seconds");
        robotUtils.unlatchUsingEncoderPosition(1, -1, 12.5);
